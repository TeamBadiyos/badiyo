...
export const mr: Partial<Record<keyof typeof en, string>> = {
  ...
  "courier.pickFromContacts": "संपर्कातून निवडा",
  "courier.contactNoNumber": "त्या संपर्काकडे वैध 10-अंकी मोबाइल नंबर नाही.",
  "courier.contactDenied": "संपर्कांची परवानगी नाकारली. कृपया नंबर टाइप करा.",
  "courier.contactUnsupported": "येथे संपर्क निवडता येत नाहीत. कृपया नंबर टाइप करा.",
  "courier.contactFailed": "संपर्क उघडता आले नाहीत. कृपया नंबर टाइप करा.",
