...
export const en = {
  ...
  "courier.modeLabel": "Choose how to send",
  "courier.modeSingle": "Send to one place",
  "courier.modeMultiDrop": "Send to many places",
  "courier.modeMultiPickup": "Collect from many places",
  ...
  "courier.shareAllOtps": "Share all OTPs",
  "courier.shareAllHeader": "Badiyos parcel {code} – delivery codes",
  "courier.shareAllFooter": "Share each code only with the rider at that drop.",
  "courier.riderAfterEarlierDrops": "Rider will reach you after earlier drops.",
  ...
  "courier.cancelConfirmTitle": "Cancel this order?",
  "courier.cancelConfirmFee": "The rider has already reached the pickup point, so a cancellation fee of ₹{fee} applies. ₹{refund} will be refunded to you in 5-7 working days.",
  "courier.cancelConfirmFree": "No cancellation fee. ₹{refund} will be refunded to you in 5-7 working days.",
  "courier.cancelConfirmPlain": "Are you sure you want to cancel this order?",
  "courier.keepOrder": "Keep order",
  "courier.yesCancel": "Yes, cancel",
