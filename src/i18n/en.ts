...
export const en = {
  ...
  "courier.pickFromContacts": "From contacts",
  "courier.contactNoNumber": "That contact has no valid 10-digit mobile number.",
  "courier.contactDenied": "Contacts permission denied. Please type the number instead.",
  "courier.contactUnsupported": "Picking contacts is not available here. Please type the number.",
  "courier.contactFailed": "Could not open contacts. Please type the number.",
